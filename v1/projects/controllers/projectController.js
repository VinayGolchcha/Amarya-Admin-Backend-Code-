...
export const createProject = async (req, res, next) => {
    try {
        ...
        const [data]= await insertProjectQuery([project, category_id, client_name, project_status, project_lead, project_manager,  start_month, end_month]);
        return successResponse(res,{project_id: data.insertId}, 'success', 'Project created successfully.');
    } catch (error) {
        next(error);
    }
};
