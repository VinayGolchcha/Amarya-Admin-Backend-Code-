...
const app = express()
const router = Router();
import { addHoliday, updateHoliday, addLeaveTypeAndCount} from '../controllers/leaveController.js';
import {addHolidayVal, updateHolidayVal, addLeaveCountVal, leaveRequestVal, updateLeaveTypeAndCountVal, deleteLeaveTypeAndCountVal, getAllLeaveCountVal} from '../../../utils/validation.js';
...
app.get('/fetch-leave-overview', fetchLeaveTakenOverview);
