...
export const createUserProjectVal = [
    ...
    //body('emp_id').isString().notEmpty().withMessage('Employee id cannot be empty.').isInt().withMessage('Invalid employee id input.'),
    body('tech').notEmpty().withMessage('technology cannot be empty.').isInt().withMessage('Invalid technology  input.'),
