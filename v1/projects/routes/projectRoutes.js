...
import { createProject, deleteProject, fetchProjects, fetchWorksheetProjects, updateProject } from '../controllers/projectController.js';
...
app.get('/fetch-worksheet-projects/:emp_id', authenticateUserAdminSession, fetchWorksheetProjects);
